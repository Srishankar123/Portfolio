  ...
  const projects = [
    {
      ...
      github: "https://github.com/Srishankar123/Data-Cleaning/tree/main/Data%20Cleaning%20Tables",
    ...
    },
    {
      ...
      github: "https://github.com/Srishankar123/Powerbi-Projects/tree/main",
    ...
    },
    {
      ...
      image: "https://raw.githubusercontent.com/Srishankar123/Excel-Projects/refs/heads/main/Quater%20One%20Report/Pictures%20Of%20the%20Tables/Pivot%20Table%20and%20Slicers.png",
      technologies: ["Excel", "Formulas", "PivotTables", "Data Cleaning"],
      github: "https://github.com/Srishankar123/Excel-Projects/tree/main/Quater%20One%20Report",
    ...
    },
    {
      ...
      image: "https://i.postimg.cc/1zm6zVzN/Screenshot-2025-07-11-200842.png",
      technologies: ["Python", "PYODBC", "SQL Server", "OOP", "Exception Handling"],
      github:
    ...
    },
    {
      ...
      github: "https://github.com/Srishankar123/Complaint-Management",
    ...
    },
    {
      ...
      image: "https://i.postimg.cc/J0NNzGgy/Screenshot-2025-07-11-211537.png", 
      technologies: ["Excel", "EDA", "Data Cleaning", "Spreadsheet Logic", "Analytics"],
      github: "https://github.com/Srishankar123/EDA-Projects/blob/main/EDA%20on%20layoffs%20dataset",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            These are real-world systems I built in Python, Flask, SQL, Excel, and Power BI. Each project demonstrates practical experience in analytics, automation, and business reporting.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            {project.live && project.live !== "#" && !project.live.endsWith(".png") && (
              <Button
                variant="outline"
                size="sm"
